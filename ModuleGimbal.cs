...
namespace ClawKSP
{
    ...
    public class MGPlusHook : MonoBehaviour
    {
        public void Start()
        {
            Controller.HookModule("ModuleGimbal", "MGPlus");
        }
    }
    ...
    public class MGPlus : PartModule
    {
        ...
        {
            if (Controller.plusActive == false || Controller.gimbalPlus == false)
            {
                plusEnabled = false;
            ...
            {
                gimbalResponseSpeed = Controller.gimbalResponseSpeed;
                gimbalRateIsActive = Controller.gimbalRateIsActive;
            }
